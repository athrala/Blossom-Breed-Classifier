...
#     print("\n**Results Table:")
#     print("# Total Images: {}".format(results_stats_dic['n_match']))
#     print("# Dog Images: {}".format(results_stats_dic['n_correct_dogs']))
#     print("# Not-a-Dog Images: {}".format(results_stats_dic['n_correct_notdogs']))
    print("\n**CNN Model Architecture:")
    print("% Not-a-Dog Correct: {:.2f}%".format(results_stats_dic['pct_correct_notdogs']))
    print("% Dogs Correct: {:.2f}%".format(results_stats_dic['pct_correct_dogs']))
    print("% Breeds Correct: {:.2f}%".format(results_stats_dic['pct_correct_breed']))
    print("% Match Labels: {:.2f}%".format(results_stats_dic['pct_match']))
