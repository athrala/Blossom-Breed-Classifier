...
def calculates_results_stats(results_dic):
    ...
    n_correct_dogs=sum(results_dic[key][3] and results_dic[key][4] for key in results_dic)
    n_correct_notdogs=sum(not results_dic[key][3] and not results_dic[key][4] for key in results_dic)
    n_correct_breed=sum(results_dic[key][2] and results_dic[key][3] for key in results_dic)
